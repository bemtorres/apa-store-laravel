...
<div class="container-fluid">
  @component('components.button._back')
    ...
    @slot('color', 'dark')
    @slot('body', 'Editar pantalla ' . $ws->nombre)
  @endcomponent
  ...
  <div class="row">
    <div class="col-md-6">
      <div class="card shadow mb-3">
        <div class="card-body">
          <form class="form-sample form-submit" action="{{ route('admin.pantalla.update', $ws->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="row mb-3">
    ...
    <div class="col-md-6">
      ...
      <div class="row">
        ...
        {{-- <form action="{{ route('workspace.pantalla.img',$ws->id) }}" class="form-submit" method="POST" enctype="multipart/form-data">
          @csrf
          @method('PUT')
