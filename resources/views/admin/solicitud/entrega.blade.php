            ...
            <table class="table table-hover table-sm" id="dataTable">
              ...
              <tbody>
                ...
                <tr id="producto-tabla-{{ $p->id }}">
                  ...
                  {{-- <td>{{ $p->usuario_solicitante->nombre_completo() }}</td> --}}
                  <td class=" text-start">
                  ...
                  {{-- <td>{{ $p->usuario_solicitante->id }}</td> --}}
                  <td>
                    <a href="{{ route('solicitud.prestamos', [$ws->id, $p->id]) }}" class="btn btn-warning btn-sm"><strong>DETALLE</strong></a>
                  </td>
                  <td>
                    {{-- <a href="{{ route('solicitud.prestamos', [$ws->id, $p->id]) }}" class="btn btn-danger btn-sm"><strong>PDF</strong></a> --}}
                  </td>
                </tr>
                @endforeach
              </tbody>
