            ...
            <div class="row">
              <div class="col-2">
                <div class="avatar avatar-md">
                  <img class="avatar-img" src="{{ asset($s->usuario->getImg()) }}" alt="user@email.com">
      ...
      <div class="modal-body">
        ...
        <form class="form-submit" action="{{ route('solicitud.update.cancelar', $s->id) }}" method="post">
          ...
          <div class="d-grid gap-3">
            <button type="submit" class="btn btn-danger btn-lg" value="cancelar" name="btnSolicitud">Si</button>
          </div>
        </form>
      </div>
    </div>
