...
<div class="container-fluid">
  @component('components.button._back')
    ...
    @slot('color', 'dark')
    @slot('body', 'Editar zona')
  @endcomponent
  <div class="row">
    <div class="col-md-6">
      <div class="card shadow mb-3">
        <div class="card-body">
          <form class="form-sample form-submit" action="{{ route('admin.config.zona.update', $s->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="row mb-3">
              ...
              <div class="d-flex justify-content-center">
                <div class="card mb-3">
                  <img src="{{ asset($s->getImg()) }}" class="img" width="200"  alt="">
                </div>
              </div>
              <div class="mb-3">
